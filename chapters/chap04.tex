...
% factory game class
The first setting \david{kdyžtak we focus on?} where we run our experiments is a class of cooperative games we call the \emph{factory games}.
...
We imagine that this\david{začátek: This game} is a very simple model of a factory, with $ n-1 $ equally productive workers, and one owner of the factory.
If the owner is present in the\david{a} coalition, the workers can work in the factory, each producing a value of $ 1 $.
...
It is rather to have a finite class of \david{superadditive} games with very simple structure, \david{zrušit}which are superadditive, and\david{až sem} on which we can thus run our algorithms and \david{compare their performance?}see how they perform.
% TODO: tohle
...
\begin{figure*}[t!]
  \centering
	\includegraphics[width=\stdfigwidth]{figures/expl_convex_linear.pdf}
	\includegraphics[width=\stdfigwidth]{figures/l1_convex_linear.pdf}
	\includegraphics[width=\stdfigwidth]{figures/l2_convex_linear.pdf}
