...
For all three divergence functions we studied, all our proposed algorithms outperform the \algRand{} approach.
% \david{dal bych tečku, zbytek je snad jasnej. Případně footnote?}, where each coalition is chosen uniformly at random.
