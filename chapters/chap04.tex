...
We can see that, no matter the divergence function\david{For all three version of the divergence functions we studied}, all our proposed algorithms outperform the \algRand{} approach, where each coalition is chosen uniformly at random.
