...
As we have shown in \Cref{thm:algfo-time-complexity-double-exp}, the time complexity of the optimal variants of the algorithms is double-exponential for sufficiently large $ \tau $.
...
It has a very rich structure, and many interesting properties \filip{citace?}\david{Mistr určitě něco bude znát}\martin{Napada me znova ten Lovasz: Submodular functions and convexity}.
