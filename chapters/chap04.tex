...
\begin{figure*}[t!]
  \centering
	...
	\caption{ The divergence as a function of budget $ \tau $ on the $ \factory[5] $ distribution for the utopian gap \citep{uradnik2024reducing} and the $ L_1 $-divergence. \david{obojí je utopian gap?}}
	\label{fig:factory}
\end{figure*}
...
To conduct our experiments, we use an an efficient algorithm for sampling from such a distribution \citep{9252865}.
