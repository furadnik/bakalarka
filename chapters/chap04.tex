...
\begin{figure*}[t!]
  \centering
	...
	\caption{ The divergence as a function of budget $ \tau $ on the $ \supermodular[5] $ distribution for the utopian gap \citep{uradnik2024reducing} and the $ L_1 $-divergence.}
...
\begin{figure*}[t!]
  \centering
	...
	\caption{ The percentage of subsets of a given size revealed in steps $1 $ to $ 12$ for the different approaches, when ran on the $\supermodular[5]$ distribution with $L_1$-divergence.
	  Similar results can be seen for the utopian gap. \filip{appendix?}
	}
...
\begin{figure*}[t!]
  \centering
	\includegraphics[width=\textwidth]{figures/linf_norm_predictible_factory5.pdf}
