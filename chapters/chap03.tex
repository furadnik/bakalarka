...
To get a solution of the online problem which is applicable \david{tohle mi nedává smysl, spíš něco jako "while being able to use it in practice"?}\martin{vyřešte to, zní to divně}\filip{co takhle?}\martin{yes} in practice, we thus turn to \emph{reinforcement learning}.
