...
\david{hodil bych nějakou omáčku jako o co vůbec půjde a jak je tahle kapitola organizovaná}\filip{souhlas, co tohle?}\david{tohle se sem podle mě nehodí. Podobnej odstavec může být na konci intra s tím, že text je organizován tak a tak. Tady by mělo být co se dělá v téhle kapitole. Stačí klidně jedna věta.}
...
This is then expanded upon in the second chapter, which offers an introduction into cooperative game theory.
Finally, independent\filip{nevim jestli independent je dobry slovo, ale asi chapes co chci rict... nejak proste ze jo, vim ze RL je uplne neco jinyho nez ty prvni dve :D} of the first two, the third chapter discusses deep reinforcement learning, a method of building and training intelligent agents.
...
\filip{nejsem si jistej zobecnenim.... co tohle}\david{jn, není to nutne subset. Tohle je good}
