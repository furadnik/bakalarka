...
<<<<<<< HEAD
Supermodularity is widely studied in various fields, most notably in cooperative game theory (which will be discussed below) and economics.\filip{TODO: citace}\martin{Neřekl bych broadly economics. Dá se asi říct všechno, kde je sub i super modularity, tj. coop hry, combinatorial auctions, matroid theory a combinatorial optimizations: https://link.springer.com/chapter/10.1007/978-3-642-68874-4_10 na comb. optimization a zbytek můžeš použít zdroje, které jsem uvedl výše}
=======
...
We denote $ \cAdditive, \cSuperadditive $ and $ \cSupermodular $ the classes of all set functions on the set $ N $ that are additive, superadditive, and supermodular (sometimes also called \emph{convex}), respectively.
