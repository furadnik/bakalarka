...
\filip{co říkáte teď na tenhle odstavec?}
...
\begin{prop}[Characterization of the Shapley value {\citep{Shapley+1953+307+318}}]
	The Shapley value $ \Shapley $ is the unique \david{Mistře, není unique linear?}\filip{podle mě to ne, linearitu zajišťuje poslední axiom} function satisfying the following properties: \begin{enumerate}[ ]
...
\filip{Co tohle? Asi po padesáté přepsáno, a už se mi to skoro začíná líbit :D}
