...
\def\Keywords{%
	{set functions\david{nemaj tady být nějaký čárky?}\filip{nooo idea...}} {reinforcement learning} {cooperative game theory} {superadditive set functions} {supermodular\david{nemá být superadditive?}\filip{a co oboji? xD} set functions}
}
