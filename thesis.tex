...
\def\Keywords{%
	{set functions\david{nemaj tady být nějaký čárky?}\filip{nooo idea...}\david{koukni co maj nějaký přijatý bakalářky, ale něco to chce...}} {reinforcement learning} {cooperative game theory} {superadditive set functions} {supermodular\david{nemá být superadditive?}\filip{a co oboji? xD}\david{nevim, zas bych to nespamoval, 3 keywords jsou sweet spot podle mě} set functions}
}
