...
\def\Keywords{%
	{set functions\david{nemaj tady být nějaký čárky?}} {reinforcement learning} {cooperative game theory} {supermodular\david{nemá být superadditive?} set functions}
}
